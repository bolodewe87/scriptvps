...
# ==================================================
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/bolodewe87/scriptvps/main/wireguard"
...
iptables -I INPUT 1 -i $SERVER_PUB_NIC -p udp --dport 2096 -j ACCEPT
